...
public class EntityAttributesMixin {
	static {
		...
		SpellEngineExtension.EXTRA_LAUNCH_DELAY = Registry.registerReference(Registries.ATTRIBUTE, SpellEngineExtension.identifier("generic.extra_launch_delay"), new ClampedEntityAttribute("attribute.name.generic.extra_launch_delay", 0.0, 0.0, 1024.0).setTracked(true));
		SpellEngineExtension.EXTRA_VELOCITY = Registry.registerReference(Registries.ATTRIBUTE, SpellEngineExtension.identifier("generic.extra_velocity"), new ClampedEntityAttribute("attribute.name.generic.extra_velocity", 0.0, 0.0, 1024.0).setTracked(true));
